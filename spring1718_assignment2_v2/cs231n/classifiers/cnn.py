...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        #pass
        self.W1=np.random.randn(num_filters, 3,filter_size,filter_size)*weight_scale
        self.b1=np.zeros(num_filters)
        self.W2=np.random.randn(int(num_filters*input_dim[1]*input_dim[2]/4),hidden_dim)*weight_scale
        self.b2=np.zeros(hidden_dim)
        self.W3=np.random.randn(hidden_dim, num_classes)*weight_scale
    ...
    def loss(self, X, y=None):
        ...
        dx3, dw3, db3=affine_backward(dscores, cache5)
        dx2, dw2, db2=affine_relu_backward(dx3, cache4)
        dx_fast = max_pool_backward_fast(dx2, cache3)
        dx_relu = relu_backward(dx_fast, cache2)
        dx1, dw1, db1 = conv_backward_fast(dx_relu , cache1)
